 ...
 * 
 * @Bean public Docket customDocket() { return new
 * Docket(DocumentationType.SWAGGER_2) .select()
 * .apis(RequestHandlerSelectors.basePackage("com.google.in.controller"))
 * .paths(PathSelectors.any()) .build() .apiInfo(apiInfo()); }
 * 
 * private ApiInfo apiInfo() { return new ApiInfoBuilder()
 * .title("CitizenInfoApplication")
 * .description("An application to search citizens by SSN Number in Rhode Island"
 * ) .version("CitizenApplication 1.0") .contact("ganesh.amit94@gmail.com")
